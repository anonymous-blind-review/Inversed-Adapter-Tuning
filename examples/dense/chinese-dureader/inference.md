...
<details>
<summary>Inference with unsupervised domain plugin and contrastively trained service model.</summary>

```bash
data_dir="./data/datasets/cpr-ecom"
backbone_name_or_path="anonymous/DAM-bert_base-mlm-dureader-cpr_ecom"
adapter_name_or_path="https://huggingface.co/anonymous/REM-bert_base-dense-contrast-dureader/resolve/main/lora192-pa4.zip"
...
<details>
<summary>Inference with unsupervised domain plugin and distilled REM.</summary>
  
```bash
data_dir="./data/datasets/cpr-ecom"
backbone_name_or_path="anonymous/DAM-bert_base-mlm-dureader-cpr_ecom"
adapter_name_or_path="https://huggingface.co/anonymous/REM-bert_base-dense-distil-dureader/resolve/main/lora192-pa4.zip"
...
backbone_name_or_path="anonymous/DAM-bert_base-mlm-dureader-cpr_video"
adapter_name_or_path="https://huggingface.co/anonymous/REM-bert_base-dense-contrast-dureader/resolve/main/lora192-pa4.zip"
...
backbone_name_or_path="anonymous/DAM-bert_base-mlm-dureader-cpr_medical"
adapter_name_or_path="https://huggingface.co/anonymous/REM-bert_base-dense-contrast-dureader/resolve/main/lora192-pa4.zip"
...
<details>
<summary>Inference with unsupervised domain plugin and distilled trained REM.</summary>
...
backbone_name_or_path="anonymous/DAM-bert_base-mlm-dureader-cmedqav2"
adapter_name_or_path="https://huggingface.co/anonymous/REM-bert_base-dense-contrast-dureader/resolve/main/lora192-pa4.zip"
...
<details>
<summary>Inference with unsupervised domain plugin and distiled service model.</summary>
