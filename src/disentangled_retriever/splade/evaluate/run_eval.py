...
def main():
    ...
    model = AutoSpladeModel.from_pretrained(model_args.backbone_name_or_path, config=config)
    ...
    if model_args.adapter_name_or_path is not None:
        ...
        if model_args.merge_lora:
            ...
            logger.info("If your service model  has LoRA modules, you can pass --merge_lora argument to merge LoRA weights and speed up inference.")
